...
public class andru {
    ...
    public static void main(String[] args) {
        ...
        //Definicion de variables generales (Variables utilizadas en todo el algoritmo)
        int opcion = 0;
        ...
        while (opcion != 6) {
            System.out.println("----------------------------------------BIENVENIDO----------------------------------------"
                    ...
                    + "\n1)Apertura de caja"
                    + "\n2)Apartado de ventas"
                    + "\n3)Apartado de compras"
                    + "\n4)Seccion de Reportes"
                    + "\n5)Cierre de caja"
                    + "\n6)Salir del sistema"
                    + "\n------------------------------------------------------------------------------------------");
            opcion = leer.nextInt();
            ...
            if (opcion == 4 && estadocaja.equals("abierto")) {
                ...
                System.out.println("\n Lista actual de productos en inventario"
                        + "\n|Producto| Cantidad de KG        "
                        + "\n|Avena   | " + cantidadavena + "  KG disponibles"
                        + "\n|Maiz    | " + cantidadmaiz + "  KG disponibles "
                        + "\n|Trigo   | " + cantidadtrigo + "  KG disponibles"
                        + "\n|Azucar  | " + cantidadazucar + " KG disponibles");
