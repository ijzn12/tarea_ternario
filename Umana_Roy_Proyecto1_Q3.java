...
public class Umana_Roy_Proyecto1_Q3 {
    ...
    public static void main(String[] args) {
        ...
        double ProductoEstrellAzucar = 0;
        double ProductoEstrellaAvena = 0;
        double ProductoEstrellaTrigo = 0;
        double ProductoEstrellaMaiz = 0;
...
// ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                ...
                // variables declaradas para el productos estrella.
                ProductoEstrellAzucar = 0;
                ProductoEstrellaAvena = 0;
                ProductoEstrellaTrigo = 0;
                ProductoEstrellaMaiz = 0;

                // se abre la caja con una condicional.
                if (cajaAbierta) {

                    double PrecioProductoVentaSumado = 0;
                    ...
                    while (ContinuarVenta == 1) {
                        ...
                        if (poderComprar) {
                            ...
                            PrecioUnitario = PrecioProducto / CantidadKiloVenta;
                            ...
                            // CONDICIONALES PARA MOSTRAR EN LA FACTURA DE VENTA Y TAMBIEN PARA EL PRODUCTO ESTRELLA 
                            if (CodigoProductoVenta == 1) {
                            ...
                            if (ProductoEstrellAzucar > maxKilos) {
                                maxKilos = ProductoEstrellAzucar;
                                productoEstrella = "Azúcar";
                            } else if (ProductoEstrellaAvena > maxKilos) {
                                maxKilos = ProductoEstrellaAvena;
                                productoEstrella = "Avena";
                            } else if (ProductoEstrellaTrigo > maxKilos) {
                                maxKilos = ProductoEstrellaTrigo;
                                productoEstrella = "Trigo";
                            } else if (ProductoEstrellaMaiz > maxKilos) {
                                maxKilos = ProductoEstrellaMaiz;
                        ...
                        Totaltotal += TotalaPagar;

                        PrecioUnitarioSumado = (TotalaPagar / CantidadKiloVentaTotal);
                        ...
                        PrecioProductoVentaSumado = Math.round(PrecioProductoVentaSumado * 100.0) / 100.0;
                        subTotalVenta = Math.round(subTotalVenta * 100.0) / 100.0;
...
// ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                ...
                if (cajaAbierta) {
                    ...
                    System.out.println("Producto(s) estrella:");
